# @file
# Script to Build Redmi Note 10S UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("rosemaryPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('rosemary', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("rosemaryPkg/rosemary.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "rosemaryPkg/rosemary.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "rosemary", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "rosemaryPkg/rosemary.dsc", "Platform Hardcoded")
